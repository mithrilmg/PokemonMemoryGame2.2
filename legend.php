...
<body>
	<script  src="jquery-3.2.1.min.js" async></script>
		<script  src="jquery-swapsies.js" type="text/javascript" async></script> 
		<script  src="memory-legend.js" async></script>
	<header>
  ...
  <source src="theme4.mp3" type="audio/mpeg">
</audio>
	...
	<main>
		...
		<article>
			...
			<div class="board" id="container">
				...
				<div class="score">Turn counter: 0</div></div></div>
